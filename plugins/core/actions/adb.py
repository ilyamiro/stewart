...
def battery_check(**kwargs):
    ...
    phone_model = run_stdout("adb", "shell", "getprop", "ro.product.manufacturer") + " " + run_stdout("adb", "shell", "getprop", "ro.product.marketname").upper()
    ...
    if battery <= 10:
        ...
        suggestion = "It will last for a few hours at least, sir"
